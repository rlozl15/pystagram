# Generated by Django 4.2.16 on 2024-11-02 18:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='following',
            field=models.ManyToManyField(related_name='follewers', through='users.Relationship', to=settings.AUTH_USER_MODEL, verbose_name='팔로우 중인 사용자들'),
        ),
    ]
